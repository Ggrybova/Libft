...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/12/15 15:38:19 by ggrybova          #+#    #+#              #
#    Updated: 2016/12/16 11:54:04 by ggrybova         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =    ft_memset.c ft_bzero.c ft_memcpy.c \
		 ...
		 ft_isascii.c ft_isprint.c ft_memalloc.c \
		 ...
		 ft_strsplit.c ft_strsplit.c ft_itoa.c \
